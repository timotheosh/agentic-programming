...
3. Are important inputs and outputs explicit?
4. Do calculations preserve their input values?
5. Does each function stay at a useful abstraction level?
6. Does each abstraction barrier hide something worth hiding, with a minimal interface?
7. Does the refactoring preserve observable behavior?
